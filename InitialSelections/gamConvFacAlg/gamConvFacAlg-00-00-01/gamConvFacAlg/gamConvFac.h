...
#ifndef Physics_Analysis_gamConvFac_H
#define Physics_Analysis_gamConvFac_H 
...
class gamConvFac : public Algorithm {

        public:
                gamConvFac(const std::string& name, ISvcLocator* pSvcLocator);
