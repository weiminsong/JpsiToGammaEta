...
#ifndef Physics_Analysis_JpsiToGamEta_H
#define Physics_Analysis_JpsiToGamEta_H 
...
class JpsiToGamEta : public Algorithm {

        public:
                JpsiToGamEta(const std::string& name, ISvcLocator* pSvcLocator);
